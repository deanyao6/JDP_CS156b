...
#SBATCH --output=resnet_frontal_training_2_h200_train_%j.out
#SBATCH --error=resnet_frontal_training_2_h200_train_%j.err
...
python resnet_frontal_training_2.py \
    ...
    --lr 1e-4 \
    --num_workers 0 \
    --output_dir checkpoints/resnet_frontal_training_2_h200